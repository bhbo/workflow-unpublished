...
(function(BpmnModeler, $) {
  ...
  function importXML(xml) {
    ...
    saveButton.addEventListener('click', function() {
	  ...
	  var submit = document.querySelector('#submitFile');
    submit.addEventListener('click', function(){

		var localFile = document.getElementById("myFile");
        if (window.ActiveXObject) {
			var xmlString = localFile.files[0].xml;
		 }
		 // code for Chrome, Safari, Firefox, Opera, etc.
		 else {
		 	var xmlString =  (new XMLSerializer()).serializeToString(localFile.files[0]);
		 }
